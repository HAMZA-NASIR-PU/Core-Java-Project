...
public class MyPractice {
	...
	public static void main(String[] args) throws ClassNotFoundException {
		...
		// MyPractice m2 = null;
		// Optional<MyPractice> o2 = Optional.of(m2); //Immediately throws a NullPointerException
		...
		MyPractice m8 = o6.orElseThrow(()-> new ClassNotFoundException("orElseThrow method working..."));
