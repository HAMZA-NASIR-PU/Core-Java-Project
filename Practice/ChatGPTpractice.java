...
public class ChatGPTpractice {
    public static void main(String[] args) {
        ...
        //Use Collectors.toList() to convert the Stream to List.
        List<Product> electronicsProducts = products\.stream().filter(product -> product.getCategory().equals("Electronics")).collect(Collectors.toList());
        ...
        //Use Collectors.toMap() to convert the Stream to List.
        ...
        double totalRevenue = products.stream().mapToDouble(product -> product.getPrice() * product.getQuantitySold()).sum();
        System.out.println("\nTotal Revenue Generated by All Products: $" + totalRevenue);

         //Group product by category and calculate total revenue generated in each category
        Map<String, Double> categoryRevenueMap = products.stream().collect(Collectors.groupingBy(Product::getCategory, Collectors.summingDouble(product -> product.getPrice() * product.getQuantitySold())));
        System.out.println("\nRevenue Generated by Each category: ");
        categoryRevenueMap.forEach((category, revenue) -> System.out.println(category + " : $" + revenue));
    }
}
